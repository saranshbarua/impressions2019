      ...
      <div className="team-content">
        ...
        <Slide bottom>
          <p className="lato-400 about">
            The team behind Impressions has devoted its months to ensure that it
            remains a memorable and truly impressionable experience for all
            those who witness it. Having a diverse set of people with skills
            ranging from Public Relations to Management and Marketing to Design,

  ...
  return (
    ...
    <ParticlesDiv />
      <div className="about-content">
        <span className="lato-400 small-lato"> <span className="pf-400" style={{fontSize: '15px'}}>03</span> THIS YEAR GET ON A TRIP WITH</span>
        <Fade duration={700} top cascade><span className="pf-400 section-heading">Ritviz</span></Fade>
        <Slide bottom>
